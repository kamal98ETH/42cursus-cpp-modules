...
int	main(void)
{
	...
	std::cout << " -> Create default DiamondTrap\n";
	DiamondTrap	dflt;

	// create object with given name
	std::cout << " -> Create named DiamondTrap\n";
	DiamondTrap	named("3ntr");

	// copy the default object using copy constructor to create a third object
	std::cout << " -> Create copy of default DiamondTrap\n";
	DiamondTrap	third(dflt); // or: DiamondTrap	third = dflt;
	third.beRepaired(30);
	
	// copy the named object using copy assignement operator to replace the third object
	std::cout << " -> reassign the third object to named DiamondTrap\n";
	third = named;
	third.beRepaired(30);
